          ...
          <Card key={index}>
            ...
            <CardContent className="flex items-center justify-center">
              <div className="flex items-center justify-center">
                ...
                <sup className="text-sm font-bold -top-[0.9rem]">/100</sup>
              </div>
            </CardContent>
          </Card>
        ))}
...
async function ScoutingReportGrades({ prospect, stats }: { prospect: any; stats: any }) {
  const prompt = `
    ...
    I want you to give me a general grading scale, typically the 20-100 scale, where:
    20-40: Well Below Average
    50: Below Average
    60: Average
    70: Above Average
    90-100: Elite
            ...
            <Card>
              ...
              <CardContent className="flex items-center justify-center">
                <p className="text-4xl font-bold">
                  ...
                  <sup className="text-sm -top-[0.9rem]">/100</sup>
                </p>
              </CardContent>
            </Card>
          </div>
